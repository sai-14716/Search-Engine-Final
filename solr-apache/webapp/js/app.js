...
function renderGroupedResults(data) {
    ...
    if (groups.length === 0) {
        searchResults.innerHTML = '<div class="no-results">No results found. Please try a different search query in RGRP.</div>';
        return;
    }
...
function renderStandardResults(data) {
    ...
    if (docs.length === 0) {
        searchResults.innerHTML = '<div class="no-results">No results found. Please try a different search query in RSR.</div>';
        return;
    }
